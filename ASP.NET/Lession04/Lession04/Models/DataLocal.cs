namespace Lession04.Models
{
    public class DataLocal
    {
        ...
        {
            new Category(){Id=1, Name="Tienhss",CreateDate= DateTime.Now, CreateBy="Tien",Status=true},
            new Category(){Id=2, Name="Linh",CreateDate= DateTime.Now, CreateBy="Tieen",Status=true},
            new Category(){Id=3, Name="Lam",CreateDate= DateTime.Now, CreateBy="Tieens",Status=false}
