...
namespace lab08.Areas.Admin.Controllers
{
    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Status,Prioty,CreatedDate,Image,Description")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Status,Prioty,CreatedDate,Image,Description")] Category category)
        {
            if (id != category.Id)
            {
                return NotFound();
